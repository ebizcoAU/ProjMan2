// /job-awards — the Builder's Job Award inbox (portaldesignspec §4.3, server xprojman-12).
// Identity-level, NOT project-scoped: an invitee can't reach the project until they accept,
// so this reads GET /job-awards/pending (status='sent', across the caller's org) and drives
// accept/decline through the project-scoped respond endpoint.
//
